...
public class Sales {
	...
	public String toString() {
		String str = code + "\t" + company + "\t" + product + "\t" + price + "\t" + amount + "\t" + money + "\t" + fee;
		return str;
	}
	...
	public static void main(String[] args) {
		Sales[] arr = { new Sales("001", "삼성", "냉장고", 500000, 10), new Sales("002", "LG", "TV", 800000, 20),
				new Sales("003", "대우", "세탁기", 700000, 25), new Sales("004", "삼보", "노트북", 1000000, 30),
